...
//clas: none-button-input
	...
	//#one-time-btn
	setBtnBottle('Triple T Reset','#input-one-time',4661,1,'TRR-SUP-BOT-ONE')
	//#six-btn
	setBtnBottle('Triple T Reset','#six-btn',4663,1,'TRR-SUP-BOT-SIX')
	//#three-btn
	setBtnBottle('Triple T Reset','#three-btn',4664,1,'TRR-SUP-BOT-TRI')
