...
/*
//Bug Cart Count
console.log($('.woocommerce-mini-cart__empty-message'))
...
//clas: none-button-input
	...
	//#one-time-btn
	setBtnBottle('Triple T Stack','#input-one-time',4518,1,'TRS-SUP-BOT-ONE')
	//#six-btn
	setBtnBottle('Triple T Stack','#six-btn',4520,1,'TRS-SUP-BOT-SIX')
	//#three-btn
	setBtnBottle('Triple T Stack','#three-btn',4521,1,'TRS-SUP-BOT-TRI')
