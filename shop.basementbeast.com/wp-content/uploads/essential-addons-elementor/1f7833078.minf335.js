...
//clas: none-button-input
	...
	//#one-time-btn
	setBtnBottle('Beast Pump','#input-one-time',157509,1,'BUM-SUP-BOT-ONE')
	//#six-btn
	setBtnBottle('Beast Pump','#six-btn',157511,1,'BUM-SUP-BOT-SIX')
	//#three-btn
	setBtnBottle('Beast Pump','#three-btn',157512,1,'BUM-SUP-BOT-TRI')
