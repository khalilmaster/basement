...
$('#add-to-cart').on('click', function() {
	...
	//#one-time-btn
	setBtnBottle('Mobility Formula','#input-one-time',157429,1,'MOB-SUP-BOT-ONE')
	//#six-btn
	setBtnBottle('Mobility Formula','#six-btn',157431,1,'MOB-SUP-BOT-SIX')
	//#three-btn
	setBtnBottle('Mobility Formula','#three-btn',157432,1,'MOB-SUP-BOT-TRI')
