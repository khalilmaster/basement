...
$('#add-to-cart').on('click', function() {
	...
	//#one-time-btn
	setBtnBottle('Daily Multivitamin','#input-one-time',157214,1,'MUL-SUP-BOT-ONE')
	//#six-btn
	setBtnBottle('Daily Multivitamin','#six-btn',157216,1,'MUL-SUP-BOT-SIX')
	//#three-btn
	setBtnBottle('Daily Multivitamin','#three-btn',157218,1,'MUL-SUP-BOT-TRI')
